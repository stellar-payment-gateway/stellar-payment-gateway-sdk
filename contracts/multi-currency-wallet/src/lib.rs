    ...
    pub fn add_balance(env: Env, asset: String, amount: i128) {
        ...
        for (i, (existing_asset, existing_amount)) in wallet.balances.iter().enumerate() {
            if existing_asset == asset {
                ...
                wallet.balances.set(i as u32, (asset.clone(), new_amount));
                found = true;
                break;
            }
        }
        ...
        if !found {
            wallet.balances.push_back((asset, amount));
        }
    ...
    fn update_balances(
        ...
        for (i, (asset, amount)) in wallet.balances.iter().enumerate() {
            if asset == from_asset {
                ...
                wallet
                    .balances
                    .set(i as u32, (from_asset.clone(), new_amount));
                break;
            }
        }
        ...
        for (i, (asset, amount)) in wallet.balances.iter().enumerate() {
            if asset == to_asset {
                ...
                wallet
                    .balances
                    .set(i as u32, (to_asset.clone(), new_amount));
                found = true;
                break;
            }
        }
        ...
        if !found {
            wallet.balances.push_back((to_asset, to_amount));
        }
