...
A robust Role-Based Access Control (RBAC) system for Stellar Payment Gateway SDK contracts on the Stellar blockchain.

## Overview

This contract provides a comprehensive RBAC implementation that can be used across all Stellar Payment Gateway SDK contracts to manage permissions and access control. It supports multiple roles, role assignment/revocation, and comprehensive event logging for audit trails.
