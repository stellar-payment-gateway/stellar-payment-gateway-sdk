...
pub enum AllowanceError {
    ...
    StillActive = 11,
    /// Allowance requires approval before it can be used (#845)
    ApprovalRequired = 12,
    /// Allowance has passed its configured end date (#839)
    Expired = 13,
    /// Cumulative distributions would exceed the configured spending limit (#836)
